...
class EnhancementCalculatorComponent extends Component {
    ...
    calculateCost() {
        ...
        if (EnhancementLvl >= 3 && cost > 0 && LevelOfCardMod > 0) {
            cost += (LevelOfCardMod - (this.state.levelOfAbilityCard * 10));
        }
        else {
            cost += LevelOfCardMod;
        }
        ...
        if (EnhancementLvl >= 4 && cost > 0 && PrevOfCardMod > 0) {
            cost += (PrevOfCardMod - (this.state.numberOfPreviousEnhancements * 25) );
        }
        else {
            cost += PrevOfCardMod;
        }
        ...
        return (
            <div className="container">
                <Container className="enhancement-container">
                    <Row className="hidden-xs">
                        <Col xs={12} md={12}>
                            <blockquote>
                                ...
                                <p>Some enhancements do not fall neatly into the categories on the cost chart. When determining their base cost, treat damage traps as "<img alt="Attack Icon" src={generalAttack} width={"12px"} /> +1" enhancements (50 gold), treat healing traps as "<img alt="Heal Icon" src={generalHeal} width={"12px"} /> +1" enhancements (30 gold), and treat the movement of tokens and tiles as "<img alt="Move Icon" src={generalMove} width={"12px"} /> +1" enhancements (30 gold).</p>                        
		                    </blockquote>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        <select className="form-select" onChange={e => EnhancementLvl = e.target.value} >
